...
<main>
    ...
    <div id="my-profile">
        ...
        if(isset($_POST["viewDetails"])){
            $orderId = $_POST["id"];
            $stmt = $db->prepare(
            "SELECT products.productName AS productName, orderdetails.price AS price, orderdetails.quantity AS quantity, orderdetails.total AS total
            FROM orderdetails
            INNER JOIN products 
                ...
                <div class="my-order">
                    <table>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td style="text-align: right;">Tổng cộng <?= number_format($totalEnd) ?> VNĐ</td>
                        </tr>
                    </table>
                </div>
            <?php //HTML
        ...
        if(isset($orders)){
            ...
            <div class="my-order">
                <table>
                    ...
                    ?>
                    <tr>
                        <td><?= date("H:i:s d-m-Y", strtotime($order['createdate'])) ?></td>
