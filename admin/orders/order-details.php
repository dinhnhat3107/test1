...
<table style="width:100%;">
    ...
    $stmt = $db->prepare(
    "SELECT products.productName AS productName, products.id AS productId, orderdetails.price AS price, orderdetails.quantity AS quantity, orderdetails.total AS total
    FROM orderdetails
    INNER JOIN products 
