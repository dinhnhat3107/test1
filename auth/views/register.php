...
<?= (isset($result) && $result === "Mật khẩu không đáp ứng yêu cầu: phải từ 8-11 kí tự, bao gồm ít nhất 1 chữ hoa, 1 chữ thường, 1 kí tự đặc biệt và 1 số") ? "<script>Swal.fire({icon: 'error',title: 'Lỗi',text: 'Mật khẩu không đáp ứng yêu cầu: phải từ 8-11 kí tự, bao gồm ít nhất 1 chữ hoa, 1 chữ thường, 1 kí tự đặc biệt và 1 số',});</script>" : "" ?>
